defmodule StringListTypeWeb.UserLiveTest do
  use StringListTypeWeb.ConnCase

  import Phoenix.LiveViewTest
  import StringListType.AccountsFixtures

  @create_attrs %{name: "some name", age: 42, nicknames: ["option1", "option2"]}
  @update_attrs %{name: "some updated name", age: 43, nicknames: ["option1"]}
  @invalid_attrs %{name: nil, age: nil, nicknames: []}
